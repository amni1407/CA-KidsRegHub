...
<html lang="en">
  <head>
    ...
    <title>PENDAFTARAN MASUK TABIKA KEMAS RAUDHATUL AISY</title>
  </head>
  <body>
    <div class="container"><br>
      <a class="btn btn-primary float-right" href="admin/login.php">Login</a>
          <h1 class="text-center">JOM MASUK TABIKA !</h1>
          <h1 class="text-center">TABIKA KEMAS RAUDHATUL AISY</h1></br>
